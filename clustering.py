...
def run_mmseqs2(input_fasta, output_dir):
    """
    Runs MMseqs2 clustering on the input FASTA file.

    Args:
        input_fasta (str): Path to the input FASTA file.
        output_dir (str): Directory to store MMseqs2 output.
    """
    subprocess.run(['mmseqs', 'easy-linclust', input_fasta, f'{output_dir}/mmseqs', f'{output_dir}/tmp', '--min-seq-id', '0.35'])
...
if __name__ == '__main__':
    ...
    # run_mmseqs2(input_fasta, mmseq_output_dir)
